...
import FeaturedDetails from "./Components/FeaturedCampaigns/FeaturedDetails";
  ...
  return (
    <UserProvider>
      <Routes>
        ...
        <Route path="/Campaigns/:id" element={<CategoryPosts />} />
        <Route
        ...
        {/* <Route path="/" element={<LandingFeaturedCampaigns />} /> */}
      </Routes>
    </UserProvider>
  );
}
